...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (savedWallet) {
        // User is connected, redirect to dashboard
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.7), rgba(255, 255, 255, 0.8)), url('/connect-bg.jpg')`
      }}
    >
      {/* Navigation */}
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-block bg-blue-50 text-blue-700 px-4 py-2 rounded-full text-sm font-medium mb-8 border border-blue-200">
            <a href="https://www.joinwebzero.com/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-900 transition-colors">
      ...
      {/* Footer */}
      <footer className="border-t border-gray-200 py-8 bg-white/70 backdrop-blur-sm">
